...
function Binstallation() {
  ...
  const deleteRow = async () => {
    try {
      await axios.delete(`https://dbarangay.onrender.com/delete/installation/${rowToDelete}`, { data: { tFirstName, tLastName, reasonDelete} });
      fetchData();
                  ...
                  <div className="popup-form">
                    <form>
                      <div className="certificate">
                        <h2 className="certificate-title">ADD INSTALLATION REQUEST </h2>
            ...
            {showEditForm && (
              <div className="popup-overlay">
                <div className="popup-form">
                  <form>
                    <div className="certificate">
                      <h2 className="certificate-title">EDIT INSTALLATION REQUEST</h2>
                      <div className="certificate-content">
                        <div className="form-group">

      ...
      <div className={`business-body ${isSidebarCollapsed ? 'expanded' : ''}`}>
        ...
        <main id="main" class="main">
          <section class="section">
            <div class="row">
              <div class="col-lg-12">
                <div id="b-indigencycard" class="card">
                  <div class="card-body">
                    <div className="row p-2 d-flex justify-content-between">
                      ...
                      <div id="b-indigency-addbtn" className="col-4 text-end ">
                    ...
                    <table id="b-indigency-table" class="table caption-top">
                      <thead>
                        <tr>
                  ...
                  <div className="popup-form">
                    <form>
                      <div className="certificate">
                        <h2 className="certificate-title">ADD INDIGENCY REQUEST </h2>
                        ...
                        <button type="submit" className="btn btn-primary" onClick={barangayIndigency}>Submit</button>
            ...
            {showEditForm && (
              <div className="popup-overlay">
                <div className="popup-form">
                  <form>
                    <div className="certificate">
                      <h2 className="certificate-title">EDIT INDIGENCY REQUEST</h2>
                      <div className="certificate-content">
                        <div className="form-group">
